...
#define VENDOR_ID       0x6473 // ds = "DrivingSouth"
#define PRODUCT_ID      0x17A0
#define DEVICE_VER      0x0100
#define MANUFACTURER    DrvSth
#define PRODUCT         WINGDL

/* key matrix size */
#define MATRIX_ROWS 10	// Y
#define MATRIX_COLS  8	// X
...
#define MATRIX_COL_PINS { B5, B4, B3, A15, A6, A7, A10, B1/*B1:OK, A5:OK A9:NG*/ }
#define UNUSED_PINS

/* encoder pins */
#define ENABLE_ENOCDER
#ifdef ENABLE_ENOCDER
  #define ENCODERS_PAD_A { A1, A3 }
  #define ENCODERS_PAD_B { A0, A2 }
...
#ifdef SEL_F103
  #define SOFT_SERIAL_PIN B6        // USART TX ピン for F103
  #define SERIAL_USART_RX_PIN B7   // for F103
  #define SERIAL_USART_DRIVER SD1  // for F103
#endif

#ifdef SEL_F401
  #define SOFT_SERIAL_PIN B6  // USART TX ピン for F401
  #define SERIAL_USART_RX_PIN B7     // for F401
  #define SERIAL_USART_DRIVER SD1		// for F401
#endif
...
#define DIP_SWITCH_PINS { C15, C14, C13 }
